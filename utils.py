...
HIGHER_RANGE_WEIGHTS = [0.1 / time for time in HIGHER_RANGE_SLEEP_TIME] # Lower weights for higher values
...
def get_random_weighted_sleep_time():
	...
	return random.choices((MAIN_SLEEP_TIMES+HIGHER_RANGE_SLEEP_TIME), weights=NORMALIZED_WEIGHTS, k=1)[0]
